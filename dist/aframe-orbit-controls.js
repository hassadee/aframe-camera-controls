...
AFRAME.registerComponent('orbit-controls', {
  ...
  init: function () {
    ...
    el.sceneEl.addEventListener('resetOrbitControls', this.resetOrbitControls);
    el.sceneEl.addEventListener('disposeOrbitControls', this.disposeOrbitControls);
  ...
  getProspectivePosition: function () {
    return this.el.getObject3D('camera').position;
  },
  getProspectiveRotation: function () {
    return this.el.getObject3D('camera').rotation;
  },
  ...
  resetOrbitControls: function() {
    /*
      ...
      ██████  ███████ ██████   ██████   ██████
    */
    console.log('██'.repeat(5) + "\t EHEHHE");
    console.log(this.el.getObject3D('camera'));
    console.log(this.el.getObject3D('camera').position);
    var oldPosition = this.el.getObject3D('camera').position;
    this.controls.reset();
    //document.querySelector( '#got-camera' ).setAttribute( 'position', oldPosition )
  },
  disposeOrbitControls: function() {
    /*
      ...
      ██████  ███████ ██████   ██████   ██████
    */
    console.log('██'.repeat(5) + "\t UDEWLDLEW");
    console.log();
  ...
  bindMethods: function() {
    ...
    this.resetOrbitControls = bind(this.resetOrbitControls, this);
    this.disposeOrbitControls = bind(this.disposeOrbitControls, this);
    this.getProspectivePosition = bind(this.getProspectivePosition, this);
    this.getProspectiveRotation = bind(this.getProspectiveRotation, this);
  },
